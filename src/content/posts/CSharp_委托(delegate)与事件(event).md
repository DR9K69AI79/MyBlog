...
comments: true
date: '2025-08-05'
description: 深入解析C#委托与事件概念，包括匿名方法、Lambda表达式、内置委托类型及多播委托使用技巧，帮助开发者提升代码灵活性与安全性。
draft: false
lastMod: '2025-08-05'
sticky: 0
summary: 文章详细介绍了C#中委托和事件的概念、使用方法及相关技术要点，包括匿名方法、Lambda表达式、内置委托类型和多播委托，并与C++函数指针进行了对比。
tags:
- 委托
- 事件
- C#
